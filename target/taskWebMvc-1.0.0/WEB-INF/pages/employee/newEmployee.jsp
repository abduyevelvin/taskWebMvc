    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" id="employeeNameId" placeholder="Enter Employee Name..." required />
            </div>
            <div class="form-group">
                <label>Surname</label>
                <input type="text" class="form-control" id="employeeSurnameId" placeholder="Enter Employee Surname..." required />
            </div>
            <div class="form-group">
                <label>Age</label>
                <input type="number" class="form-control" id="employeeAgeId" placeholder="Enter Employee Age..." min="0" />
            </div>
            <div class="form-group">
                <label>Job Title</label>
                <input type="text" class="form-control" id="employeeJobId" placeholder="Enter Empliyee Job Title..." />
            </div>
            <div class="form-group">
                <label>Choose City</label>
                <select class="form-control" id="cityCmbId" required>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <button type="button" id="clearEmployeeBtnId" class="btn btn-danger btn-block btn-flat">Clear</button>
                </div>
                <!-- /.col -->
                <div class="col-xs-6">
                    <button type="button" id="addEmployeeBtnId" class="btn btn-block btn-primary btn-flat">Create</button>
                </div>
            </div>
